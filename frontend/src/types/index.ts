...
export interface Client extends PerfilTributario {
  id: string;
  contadorId: string;
...
export interface Credential {
  ...
  usuario?: string;
  // La password desencriptada solo se muestra cuando se solicita explícitamente
...
export type TipoVencimiento =
  | 'iva' | 'irae_anticipo' | 'irae_liquidacion'
  | 'irpf_cat1' | 'irpf_cat2'
  | 'bps_patronal' | 'bps_personal'
  | 'fonasa' | 'cjppu' | 'fondo_solidaridad'
  | 'dj_anual' | 'personalizado';
...
export type TipoNotificacion =
  | 'vencimiento_proximo' | 'boleto_pendiente' | 'honorario_vencido'
  | 'pago_confirmado' | 'consulta_recibida' | 'consulta_respondida' | 'sistema';
