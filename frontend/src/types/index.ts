...
export interface Client extends PerfilTributario { id: string; contadorId: string; usuarioClienteId?: string; nombre: string; apellido: string; ci?: string; telefono?: string; email?: string; direccion?: string; razonSocial?: string; rut?: string; nroBps?: string; tipoEmpresa?: TipoEmpresa; giro?: string; fechaInicioActividades?: string; exoneracionIva: boolean; exoneracionIrae: boolean; exoneracionDetalle?: string; estado: EstadoCliente; notas?: string; createdAt: string; updatedAt: string; }
export type PlataformaCredencial = 'dgi' | 'bps' | 'facturacion_electronica' | 'cjppu' | 'fonasa' | 'banco' | 'gub.uy' | 'otro';
export interface Credential { id: string; clientId: string; plataforma: PlataformaCredencial; nombrePlataforma?: string; usuario?: string; passwordDesencriptado?: string; pin?: string; url?: string; mfa?: boolean; notas?: string; vigente: boolean; }
