...
> Última actualización: 2026-03-07 · v1.0.8 en producción
...
1. ✅ ~~Fix theming `ClientDetailPage`~~ — hecho en v1.0.8
2. ✅ ~~Responsive mobile — tablas → cards~~ — hecho en v1.0.8
...
- **Versiones**: `versions.env` — actualmente `1.0.8`
