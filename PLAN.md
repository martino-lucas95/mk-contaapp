...
> Última actualización: 2026-03-07 · v1.1.1 en producción
...
1. ✅ ~~Fix theming `ClientDetailPage`~~ — hecho en v1.1.1
2. ✅ ~~Responsive mobile — tablas → cards~~ — hecho en v1.1.1
...
- **Versiones**: `versions.env` — actualmente `1.1.1`
